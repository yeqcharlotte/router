...
# Run LM evaluation using lm_eval harness for Llama 3.1 with vllm-router (P-D disaggregation)
...
echo "============================================"
echo "Running LM Eval - vllm-router (P-D)"
echo "============================================"
echo "Task: $TASK"
echo "Model: $MODEL"
...
echo "      Requests routed with P-D disaggregation (prefill → decode)"
